...
highest_row = gap_07.sort_values("lifeExp", ascending=False).head(5).squeeze()
highest_life_exp_country = highest_row["country"]
highest_life_exp_value = round(highest_row["lifeExp"], 1)

print(f"country with the highest number: {[highest_row]}")
print(f"country with the highest life expectancy: {[highest_life_exp_country]}")
```
