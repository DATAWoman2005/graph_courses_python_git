...
::: {.valuebox title="Year with Highest Rate" icon="exclamation-octagon" color="warning"}
...
::: {.valuebox title="Staggering Male Suicide Disparity" icon="people" color="warning"} 
...
::: {.valuebox title="Global Average Suicide Rate" icon="exclamation-triangle" color="danger"}
...
::: {.valuebox title="The Year with the Highest Global Average Suicide Rate" icon="exclamation" color="danger"}
