...
table_df = emissions[["country", "2000", "2022"]].copy()  # Use .copy() to explicitly create a new DataFrame

# Convert `2000` and `2022` columns to numeric
...
# Calculate "Relative Change" as (absolute change / 2000 emissions) * 100
table_df["Relative Change"] = (table_df["Absolute Change"] / table_df["2000"]) * 100

# Format "Relative Change" to include "%" and round to 0 decimal places
